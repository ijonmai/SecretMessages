...
# Turns argument into binary, removes the 0b and fills with leading 0s
...
def changeBits(pixels, li, position):
    ...
    while li:
        r, g, b = pixels[i]
        # change r to binary, converts to list, sets the last bit of r to the top of li
        #then pops li for g to do the same
        r = bin(r)[2:].zfill(8)
        r = list(r)
        r[7] = li[0]
        li.pop(0)
        ...
        # change g to binary, converts to list, sets the last bit of r to the top of li
        # then pops li for b to do the same
        g = bin(g)[2:].zfill(8)
        g = list(g)
        g[7] = li[0]
        li.pop(0)
        ...
        # change b to binary, converts to list, sets the last bit of r to the top of li
        # then pops li for the while loop to continue and eventually end
        b = bin(b)[2:].zfill(8)
        b = list(b)
        b[7] = li[0]
        li.pop(0)
...
if __name__ == '__main__':
    ...
    # Error Checking
    # The first if checks if the text will be too big to embed into image
    # The second if checks if there is text if the user runs -e
